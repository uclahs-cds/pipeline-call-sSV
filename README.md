...
| min_clique_size | yes | integer | Minimum number of supporting PE or SR read alignments required for a clique to be identified as a structural variant by Delly. Adjust this parameter to control the sensitivity and specificity of Delly variant calling. |
